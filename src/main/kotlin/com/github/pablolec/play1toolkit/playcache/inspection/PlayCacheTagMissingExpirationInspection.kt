...
class PlayCacheTagMissingExpirationInspection : LocalInspectionTool() {
    ...
    override fun buildVisitor(holder: ProblemsHolder, isOnTheFly: Boolean): PsiElementVisitor {
        ...
        val fragments = PlayCacheService.getInstance(holder.project).getTemplateFragments()
            .filter { it.templateFile == holder.file && it.ttl is PlayCacheTtl.Absent && it.key !is PlayCacheKey.Missing }
            ...
            override fun visitElement(element: PsiElement) {
                ...
                fragments.forEach { fragment ->
                    ...
                    holder.registerProblem(
                        element,
                        "Cache fragment has no explicit expiration",
